    ...
    try:
        ...
        if pastas:
            ...
            for pasta, phone, endereco, instalador, is_recorrente, date, obra in zip(pastas, phones_num, enderecos,
                ...
                if instalador not in mensagem_enviada and ficha_encontrada:
                    bom_dia_enviado = True
                    time.sleep(1)
                ...
                if pasta_diaria:
                    ...
                    if diretorio_busca:
                        ...
                        if arquivos_filtrados and is_recorrente == 'N':
                            ...
                            if instalador not in mensagem_enviada and not ficha_encontrada:
                                bom_dia_enviado = True
                                time.sleep(1)
                                saudacao = (f"Olá, {instalador}! Tudo bem?\n"
                                            f"Endereço da Obra: {endereco}")
                                enviar_mensagem(driver, saudacao)
                ...
                if instalador not in mensagem_enviada and bom_dia_enviado:
                    time.sleep(2)
